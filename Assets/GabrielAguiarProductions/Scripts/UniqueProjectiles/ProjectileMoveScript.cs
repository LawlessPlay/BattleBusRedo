...
public class ProjectileMoveScript : MonoBehaviour {
    ...
    private GameEvent triggerAction;
	...
	void FixedUpdate () {
		if (target != null)
		{
			var targetTransform = new Vector3(target.transform.position.x, target.transform.position.y+1, target.transform.position.z);
			rotateToMouse.RotateToMouse(gameObject, targetTransform);
		}
    ...
    public void SetTarget (GameObject trg, RotateToMouseScript rotateTo, GameEvent triggerAction)
    {
        target = trg;
